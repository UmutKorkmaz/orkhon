...
> 22M unified EN/TR/Kokturk assistant SFT from the former Kultegin story-instruct checkpoint. Exact rune transliteration is served through the deterministic assistant router.
...
```bash
uv run orkhon chat --checkpoint models/tegin-20260620/checkpoint --tokenizer models/tegin-20260620/tokenizer
```
